...
#include "siftp.h"
	...
	/* command funcs */
		...
		Boolean cmd_pwd(const int a_socket, const String a_cmdStr);
		Boolean cmd_cd(const int a_socket, const String a_cmdStr);
		Boolean cmd_get(const int a_socket, const String a_cmdStr);
		Boolean cmd_put(const int a_socket, const String a_cmdStr);
